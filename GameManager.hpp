...
private:
    ...
    size_t menuHeight = 40;
    size_t menuWidth = 120;
    size_t infoWindowWidth = 40;

    size_t minMapWidth = 10;
    size_t minMapHeight = 10;
    size_t maxMapWidth = 105;
    size_t maxMapHeight = 45;
};